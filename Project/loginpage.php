                ...
                <div class="ui segment" style="">
                    <center>
                        ...
                        <div style="margin-left: 40px; margin-right: 40px; padding-top: 10px;">
                            <form class="ui form" method="POST" action="proseslogin.php" id="form">
                                ...
                                <button class="ui blue button" type="submit" >Login
                                </div>
                                <div class="ui error message">

                                </div>
                            </form>
                            <p>Don't have an account? Sign up<a href="signuptim.php"> here</a></p>
                        </div>
                    </center>
                </div>
            </div>
